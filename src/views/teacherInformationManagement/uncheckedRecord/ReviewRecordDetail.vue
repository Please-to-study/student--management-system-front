<template>
  <PageWrapper
    :title="`待审核学习记录:` + learningRecordInfo?.studentName + `的学习记录`"
    contentBackground
    @back="goBack"
  >
    <template #extra>
...
<script lang="ts" setup>
  ...
  import { learningRecordSchema } from '@/views/courseInformationManagement/reviewRecord/account.data';
  ...
  // 页面左侧点击返回链接时的操作
  function goBack() {
    go('/courseInformationManagement/reviewRecord');
  }
</script>
